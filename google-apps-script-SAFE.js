...
// Add your Gemini API key here (REGENERATE the exposed one first!)
// Get it from: https://makersuite.google.com/app/apikey
const GEMINI_API_KEY = "YOUR_NEW_GEMINI_API_KEY_HERE";

// Set to false to disable AI alt text (recommended until billing is resolved)
const ENABLE_AI_ALT_TEXT = false;
  ...
  try {
    ...
    while (files.hasNext()) {
      ...
      if (mimeType.startsWith('image/') || mimeType.startsWith('video/')) {
        ...
        if (!fileDescription && mimeType.startsWith('image/') && ENABLE_AI_ALT_TEXT && GEMINI_API_KEY !== 'YOUR_NEW_GEMINI_API_KEY_HERE') {
          try {
